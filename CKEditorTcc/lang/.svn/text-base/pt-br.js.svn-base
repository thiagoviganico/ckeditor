...
CKEDITOR.lang[ 'pt-br' ] = {
	...
	common: {
		...
		editorHelp: 'Pressione ALT+0 para ajuda, Pressione ALT+1 para lista de teclas de atalho', //TODO fazer esta alteração quando o plugin keystrokehelp é adicionado

...
CKEDITOR.dialog.add( 'a11yHelp', function( editor ) {
	...
	var replaceVariables = (function() {
		...
		return function( match, name ) { // match->guarda ${bold} ; name->guarda a correspondente 'bold'
	...
	function buildHelpContents() {
		var pageTpl = '<div class="cke_accessibility_legend" role="document" aria-labelledby="' + id + '_arialbl" tabIndex="-1">%1</div>' +
			...
			sectionTpl = '<dl>%2</dl>',
			itemTpl = '<dt>%1<p>%2</p></dt>';

		var pageHtml = [],
			sections = lang.legend, //armazena um grupo inteiro com seu nome e itens já no edioma padrão

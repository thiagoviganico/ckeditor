...
/**
 * @fileOverview Plugin definition for the keyStrokesHelp, which provides a dialog
 * with accessibility related help.
 */

(function() {
	var pluginName = 'keyStrokesHelp',
		commandName = 'keyStrokesHelp';
...
requires: 'dialog',
		...
		init: function( editor ) {
			...
			editor.addCommand( commandName, {
				exec: function() {
					...
					CKEDITOR.scriptLoader.load( CKEDITOR.getUrl( plugin.path + 'dialogs/lang/' + langCode + '.js' ), function() {
						editor.lang.keyStrokesHelp = plugin.langEntries[ langCode ];
			...
			editor.setKeystroke( CKEDITOR.ALT + 97 /*1*/, 'keyStrokesHelp' ); //numero 1
			editor.setKeystroke( CKEDITOR.ALT + 49 /*1*/, 'keyStrokesHelp' ); //numero 1 TECLADO NUMÉRICO
			CKEDITOR.dialog.add( commandName, this.path + 'dialogs/keyStrokesHelp.js' );
		}
	});
})();
